...
class Calculator_1_1(QWidget):
    def setupUi(self, Calculator_1_1):
        super().__init__()
        Calculator_1_1.setObjectName("Calculator_1_1")
        Calculator_1_1.setFixedSize(480, 558)  # 固定窗口大小
        ...
        self.current = ''  # 内部算式
        self.centralwidget = QtWidgets.QWidget(Calculator_1_1)
        ...
        self.action_about = QAction(Calculator_1_1)
        ...
        self.action_history = QAction(Calculator_1_1)
        ...
        Calculator_1_1.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(Calculator_1_1)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 480, 23))
        self.menubar.setObjectName("menubar")
        self.menu = QtWidgets.QMenu(self.menubar)
        self.menu.setObjectName("menu")
        Calculator_1_1.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(Calculator_1_1)
        self.statusbar.setObjectName("statusbar")
        Calculator_1_1.setStatusBar(self.statusbar)

        self.menubar.addAction(self.menu.menuAction())

        self.retranslateUi(Calculator_1_1)
        QtCore.QMetaObject.connectSlotsByName(Calculator_1_1)

    def retranslateUi(self, Calculator_1_1):
        _translate = QtCore.QCoreApplication.translate
        Calculator_1_1.setWindowTitle(
            _translate("Calculator_1_1", "Calculator V1.1"))
        self.textBrowser.setText('0')
        self.pushButton_C.setText(_translate("Calculator_1_1", "C"))
        self.pushButton_Del.setText(_translate("Calculator_1_1", "←"))
        self.pushButton_Sqrt.setText(_translate("Calculator_1_1", "√"))
        self.pushButton_Div.setText(_translate("Calculator_1_1", "÷"))
        self.pushButton_7.setText(_translate("Calculator_1_1", "7"))
        self.pushButton_8.setText(_translate("Calculator_1_1", "8"))
        self.pushButton_9.setText(_translate("Calculator_1_1", "9"))
        self.pushButton_Times.setText(_translate("Calculator_1_1", "×"))
        self.pushButton_4.setText(_translate("Calculator_1_1", "4"))
        self.pushButton_5.setText(_translate("Calculator_1_1", "5"))
        self.pushButton_6.setText(_translate("Calculator_1_1", "6"))
        self.pushButton_Minus.setText(_translate("Calculator_1_1", "-"))
        self.pushButton_1.setText(_translate("Calculator_1_1", "1"))
        self.pushButton_2.setText(_translate("Calculator_1_1", "2"))
        self.pushButton_3.setText(_translate("Calculator_1_1", "3"))
        self.pushButton_Plus.setText(_translate("Calculator_1_1", "+"))
        self.pushButton_Sign.setText(_translate("Calculator_1_1", "+/-"))
        self.pushButton_0.setText(_translate("Calculator_1_1", "0"))
        self.pushButton_Dot.setText(_translate("Calculator_1_1", "."))
        self.pushButton_Eq.setText(_translate("Calculator_1_1", "="))
        self.pushButton_Cos.setText(_translate("Calculator_1_1", "cos"))
        self.pushButton_lg.setText(_translate("Calculator_1_1", "1/lg"))
        self.pushButton_Sin.setText(_translate("Calculator_1_1", "sin"))
        self.pushButton_Ln.setText(_translate("Calculator_1_1", "ln"))
        self.pushButton_Pow.setText(_translate("Calculator_1_1", "^"))
        self.pushButton_Fac.setText(_translate("Calculator_1_1", "n!"))
        self.pushButton_Pi.setText(_translate("Calculator_1_1", "pi"))
        self.pushButton_LeftPar.setText(_translate("Calculator_1_1", ")"))
        self.pushButton_Abs.setText(_translate("Calculator_1_1", "|x|"))
        self.pushButton_RightPar.setText(_translate("Calculator_1_1", "("))
        self.menu.setTitle(_translate("Calculator_1_1", "计算"))
